...
class SpanSiblingBar extends React.Component<Props> {
  ...
  renderGroupedSpansToggler() {
    const {treeDepth, toggleSpanGroup, siblingCount} = this.props;
